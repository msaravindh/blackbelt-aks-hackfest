...
7. Find your RG name
    ...
    # copy the resource group name from the results above and set to a variable 
...
11. Verify you have API access to your new AKS cluster
    ...
    aks-nodepool1-13757066-0   Ready     agent     56m       v1.9.6
    aks-nodepool1-13757066-1   Ready     agent     56m       v1.9.6
    ...
    Kubernetes master is running at https://myaksrgtes-myaksrgtest-9a4f9a-88c59529.hcp.eastus.azmk8s.io:443
    Heapster is running at https://myaksrgtes-myaksrgtest-9a4f9a-88c59529.hcp.eastus.azmk8s.io:443/api/v1/namespaces/kube-system/services/heapster/proxy
    KubeDNS is running at https://myaksrgtes-myaksrgtest-9a4f9a-88c59529.hcp.eastus.azmk8s.io:443/api/v1/namespaces/kube-system/services/kube-dns:dns/proxy
    kubernetes-dashboard is running at https://myaksrgtes-myaksrgtest-9a4f9a-88c59529.hcp.eastus.azmk8s.io:443/api/v1/namespaces/kube-system/services/kubernetes-dashboard/proxy
